        ...
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          {(!filterProdi || !filterTahun) ? (
            <div className="p-20 text-center">
              ...
              <p className="text-gray-400 font-bold text-lg">Silakan pilih Program Studi dan Anchor (TS) terlebih dahulu</p>
            </div>
          ) : (
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            {trashData.length === 0 ? (
              <div className="p-20 text-center">
                ...
                <p className="text-gray-400 font-bold text-lg">Tempat sampah kosong</p>
              </div>
            ) : (
